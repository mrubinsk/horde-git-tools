...
namespace Horde\GitTools\Components\Config;
 ...
 * configuration of the components tool.
 *
 * Override the Components version of this to get rid of duplicate/not-needed
 * configuration options when using within horde-git-tools.
 *
